...
test("seed is 75 (v615/v631.1: the owner's LIVE Chronicle — Jul 9 spree + Bulwark from his ladder char)", async ({ page }) => {
  ...
  expect(r.count).toBe(75);   // v631.1 spree + Bulwark (Jul 10 — his FIRST ladder-char forge in the seed)
