...
test("seed is 45 (+ Spirit + Grief + Stone + Enigma + Doom + Plague + Treachery + Zephyr + Memory + Rift + Void + Fury + Gloom + Obsession added to the floor)", async ({ page }) => {
  ...
  expect(r.count).toBe(45);   // v503 added Obsession
