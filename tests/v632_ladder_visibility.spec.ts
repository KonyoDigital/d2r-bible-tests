...
async function liveState(page: any) {
  ...
  await page.evaluate(({ owned, runes }: any) => {
    ...
    const POST = ['Cure','Ground','Hearth','Hysteria','Mania','Temper','Eternity','Metamorphosis','Bulwark','Silence','Exile','Radiance','Ritual','Rain','Vigilance','Ice','Faith','Enlightenment','Lionheart','Wealth','Myth'];   // v671 — keeps the pinned Jul-9 snapshot at exactly 74
