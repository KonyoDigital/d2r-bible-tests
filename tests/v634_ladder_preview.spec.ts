...
test('toggle expands the remaining 4 plan cards (recipes + base + 🪜 ribbon, Hustle = legacy note), collapses back — and game state is BYTE-IDENTICAL', async ({ page }) => {
  ...
  expect(r.expanded.count).toBe(4);   // v648: Cure/Ground/Hearth/Temper seeded MADE too — only Meta/Mania/Hysteria/Hustle remain
