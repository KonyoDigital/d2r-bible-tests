...
|---|---|---|
| **v2946** | `(this commit)` | v2946 — --note four modules each declared the order a reel moves through; nothing has ever stamped INTAKE or TOMBSTONE, and 36 reels left without one |
