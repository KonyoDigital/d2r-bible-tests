...
|---|---|---|
| **v2929** | `(this commit)` | v2929 — --note v2927 fixed 280 of 330 rows and said no unbound row; 50 legacy two-column rows had no SHA slot and were silently outside the claim |
