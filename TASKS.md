...
|---|---|---|
| **v3064** | `(this commit)` | v3064 — the shelf lane header printed 8 REELS from a count of visible cards while the river strip four inches above printed 4 from the routers own reel count - 425 cards against 16 reels, two populations under one word; the number was never wrong, only the noun |
