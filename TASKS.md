...
|---|---|---|
| **v3035** | `(this commit)` | v3035 — the fleet xref could only be closed by its own tiny cross while covering the whole console, its reachability was never once proven by clicking anything, and the river lane headers ate 57 percent of the band above the first reel card |
