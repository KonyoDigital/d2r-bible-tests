...
|---|---|---|
| **v3019** | `(this commit)` | v3019 — the render gate refused a sixth zero-size node; the floor of 5 was never a tolerance, it counts closed modals, and v3016 added one. Raised by hand rather than by bless, because bless refuses to write from a partial run and the red target was the thing it would have fixed. |
