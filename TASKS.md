...
|---|---|---|
| **v3255** | `(this commit)` | v3255 — live_store joined before expanding so a home path was always reported absent and a gate would stand down on a machine that has the data. and a review saying no concrete defects found was filed as findings because Nothing was missing from the negation vocabulary |
