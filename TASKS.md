...
|---|---|---|
| **v3191** | `(this commit)` | v3191 — Every red proof in the shelf region now points at text that exists, and two laws whose subject the river ruling deleted were re-derived rather than left skipping. A skip is not a pass and a law that skips forever hides the absence it was written to notice. |
