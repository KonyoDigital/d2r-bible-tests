...
|---|---|---|
| **v2939** | `(this commit)` | v2939 — --note the git-unreadable arm reported zeros while its sibling reported None, so a broken instrument read as a measured empty table |
