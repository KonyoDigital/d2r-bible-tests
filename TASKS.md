...
|---|---|---|
| **v3254** | `(this commit)` | v3254 — four console surfaces painted an item name from the find TIER, so a set piece read unique gold. HEART: test_a_name_takes_its_colour_from_its_rarity watches the joint, 4 red-proofs seen RED |
