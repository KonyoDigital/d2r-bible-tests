...
|---|---|---|
| **v3069** | `(this commit)` | v3069 — ten surfaces sat one organ short and all ten were missing the corroborator because that organ needs two independent witnesses and six of the eight loops leave nothing an outside reader can date; the two that do are now covered and the other six stay honestly absent |
