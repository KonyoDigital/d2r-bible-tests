...
|---|---|---|
| **v3073** | `(this commit)` | v3073 — the lock evidence organ painted eight locks covered without asking whether any evidence was readable - three had none at all - and it can only read harnesses that declare a module level CLAIMS, which are exactly the sources that cannot inflate |
