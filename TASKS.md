...
|---|---|---|
| **v3096** | `(this commit)` | v3096 — the meter returned two lanes since v3092 and rendered one - the panel lives in bible.html and I searched control_ui.html. And a windowed console goes dark within twenty seconds of losing focus, which is every black stage the eyes lane ever reported |
