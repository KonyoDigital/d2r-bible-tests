...
|---|---|---|
| **v3020** | `(this commit)` | v3020 — the GATES section was the count 322 and named none of them, so 32 existing laws went unfound and were nearly rebuilt. Every gate already carried a why - 322 of 322 - so the material was always there and simply never rendered. Also: three places cited the character-name ruling at an item-name problem. |
