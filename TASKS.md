...
|---|---|---|
| **v3226** | `(this commit)` | v3226 — two of his three vault-lane reels were sealed by the current reader with zero rows and were still reported as waiting on a sweep, which is the question he has now asked twice. the split is waiting, barren and banked, the barren ones stay held and counted because a seal is not an extraction, and an unreadable seal store is UNKNOWN rather than nothing-sealed |
