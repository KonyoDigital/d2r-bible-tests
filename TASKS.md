...
|---|---|---|
| **v2995** | `(this commit)` | v2995 — every other doctor check can be answered 200 by a console painting nothing; this one hashes screencaptures of the real window, and its own first run produced three false positives that all looked like a dead console |
