...
|---|---|---|
| **v3062** | `(this commit)` | v3062 — kaiClasses collapses to stash gameplay tooltip and has no TOWN bucket so a town frame is filed under whichever of the three is nearest; the journal carries the real scene vocabulary alongside it and 148 of 160 sessions name different scenes, which nothing was comparing until now |
