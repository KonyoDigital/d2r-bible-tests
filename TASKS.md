...
|---|---|---|
| **v3094** | `(this commit)` | v3094 — six vault stores now copy to a timestamped folder that is read back at source size, refusing the whole save on any mismatch. The module cannot delete by construction - no remove, unlink, rmtree, and no store opened for writing - because the wipe he asked for is a separate twice-asking act |
