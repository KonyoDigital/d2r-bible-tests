...
|---|---|---|
| **v2996** | `(this commit)` | v2996 — a DOM can be fully built inside a container that occupies no pixels; the beat published a fill and never a rect, so nothing in it could contradict his eyes |
