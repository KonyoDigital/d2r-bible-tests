...
export async function onRequestPost(context) {
  ...
  const itemsText = 'You read Diablo 2 Resurrected screenshots (stash/inventory panels, ground loot, hover tooltips). '
    ...
    + '"+N% Enhanced Defense" superior line) as for a plain white one: a Superior Trident showing "Socketed (3)" is '
    + '{base:"Trident", count:3, q:"superior"} — do NOT report it without the socket count. If the base name is legible '
