...
export async function onRequestPost(context) {
  ...
  const itemsText = 'You read Diablo 2 Resurrected screenshots (stash/inventory panels, ground loot, hover tooltips). '
    ...
    + '(a Larzuk candidate). If the base name is legible but the socket digit is blurry, prefer leaving it OUT over '
    + 'reporting a wrong low count. CRITICAL: only count when the '
