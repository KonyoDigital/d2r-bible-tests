...
RED_PROOF = [
    {
        "why": 'the law requires this text in extract_gap.py, where it occurs exactly once and in no other file the gate names; deleting it must turn the gate red',
        "file": 'extract_gap.py',
        "find": 'holdingPossible',
