...
RED_PROOF = [
    {
        "why": 'the law requires this text in vault_retro.py, where it occurs exactly once and in no other file the gate names; deleting it must turn the gate red',
        "file": 'vault_retro.py',
        "find": 'gating on RAW reader names',
