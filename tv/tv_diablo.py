...
VERSION = "v1218"   # 🧠🖥 ENGINE ROOM arc round 9 — REEL SCORECARD (the reel's SHAPE before you drill). The retro side was deep at the FRAME level but had no REEL-level overview — scrub in and you saw one frame's organs, not the whole reel's shape. FIX: a scorecard under the readout the moment you scrub into a reel — DURATION · FRAMES · READS · NAMED · 🧠 RETRO-CAUGHT · TALLIES + a notable line (⚠ watchdog / ↩ regrets) — e.g. "📊 REEL 55 · 2m 31s · 147 frames · 26 reads · 18 named · 🧠 40 retro-caught · ⚠ 3 watchdog". Completeness-doctrine framing: NAMED highlights green (items found), retro-caught = KAI strength (film had what live missed), never a scary miss%. Retro-only (hidden idle/live so it never implies live activity). All fields from the /api/sessions reel summary (no new endpoint). Future data noted: per-reel gate pass/held split + owner-share not in the summary today (left off vs faked). control_ui.html only. ×3 parity (46/80 → v1272)
