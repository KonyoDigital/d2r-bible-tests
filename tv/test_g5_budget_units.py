...
RED_PROOF = [
    {
        "why": 'the law requires this text in intake_grok_sub.mjs, where it occurs exactly once and in no other file the gate names; deleting it must turn the gate red',
