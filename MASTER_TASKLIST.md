...
- ⬜ **G3 · SUNDER-CHARM AUTO-TALLY** [bible.html + engine] — the SUNDER CHARMS tracker (Materials Stash & Uber Planner) sits empty though KAI has read Konyo's sunder charms dozens of times. Wire KAI item-recognition of the 6 sunder charms (Crack of the Heavens/Rotting Fissure/Bone Break/Flame Rift/Black Cleft/Cold Rupture) → AUTO-TALLY into the sunder tracker (what he has IN). Generalizes the AI-smart stash sync (reads → auto-populate trackers). See [[d2r_ai_smart_stash_sync]].
